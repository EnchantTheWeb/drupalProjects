...
class __TwigTemplate_59de0081d1e855e66b34adf247eb28e6 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/bartik/templates/classy/content-edit/filter-tips.html.twig", "C:\\xampp\\htdocs\\drupalInternetForum\\core\\themes\\bartik\\templates\\classy\\content-edit\\filter-tips.html.twig");
    }
